 ...
 */
class SlideLoading @JvmOverloads constructor (
        context: Context,
    ...
    private fun startAnimationComplete() {
        ...
        animSet.addListener(object : Animator.AnimatorListener {
            override fun onAnimationStart(p0: Animator?) {
                onSlideToActAnimationEventListener?.onSlideCompleteAnimationStarted(this@SlideLoading, mPositionPerc)
            }
            ...
            override fun onAnimationEnd(p0: Animator?) {
                mIsCompleted = true
                onSlideToActAnimationEventListener?.onSlideCompleteAnimationEnded(this@SlideLoading)
                onSlideCompleteListener?.onSlideComplete(this@SlideLoading)
            }
    ...
    private fun startAnimationReset() {
        ...
        animSet.addListener(object : Animator.AnimatorListener {
            override fun onAnimationStart(p0: Animator?) {
                onSlideToActAnimationEventListener?.onSlideResetAnimationStarted(this@SlideLoading)
            }
            ...
            override fun onAnimationEnd(p0: Animator?) {
                isEnabled = true
                stopTickAnimation()
                onSlideToActAnimationEventListener?.onSlideResetAnimationEnded(this@SlideLoading)
                onSlideResetListener?.onSlideReset(this@SlideLoading)
            }
    ...
    interface OnSlideToActAnimationEventListener {
         ...
         */
        fun onSlideCompleteAnimationStarted(view: SlideLoading, threshold: Float)
         ...
         * @param view The SlideToActView who created the event
         */
        fun onSlideCompleteAnimationEnded(view: SlideLoading)
         ...
         * @param view The SlideToActView who created the event
         */
        fun onSlideResetAnimationStarted(view: SlideLoading)
         ...
         * @param view The SlideToActView who created the event
         */
        fun onSlideResetAnimationEnded(view: SlideLoading)
    }
    ...
    interface OnSlideCompleteListener {
         ...
         * @param view The SlideToActView who created the event
         */
        fun onSlideComplete(view: SlideLoading)
    }
    ...
    interface OnSlideResetListener {
         ...
         * @param view The SlideToActView who created the event
         */
        fun onSlideReset(view: SlideLoading)
    }
    ...
    interface OnSlideUserFailedListener {
         ...
         */
        fun onSlideFailed(view: SlideLoading, isOutside: Boolean)
    }
